...
document.getElementById('pool3Percent').innerText = `${Math.trunc(totalsOwned.get('Pool 3 (Collection Level 486-?)')/totals.get('Pool 3 (Collection Level 486-?)'))}%`;
document.getElementById('pool4Percent').innerText = `${Math.trunc(totalsOwned.get('Pool 4 (Series 4)')/totals.get('Pool 4 (Series 4)'))}%`;
document.getElementById('pool5Percent').innerText = `${Math.trunc(totalsOwned.get('Pool 5 (Series 5)')/totals.get('Pool 5 (Series 5)'))}%`;
